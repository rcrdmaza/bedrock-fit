  ...
  return (
    <main className="min-h-screen bg-slate-50">
      ...
      {/* Banner skeleton — keeps the layout from jumping when the real
          ...
          placeholder. */}
      <section className="bg-slate-50 pt-12 pb-10" aria-hidden="true">
        <div className="max-w-3xl mx-auto px-8 flex flex-col items-center text-center gap-3">
          ...
          <div className="h-8 w-56 bg-slate-100 rounded animate-pulse mt-2" />
      ...
      <section className="max-w-3xl mx-auto px-8 pt-12 pb-24">
        ...
        <div
          className="grid grid-cols-3 gap-x-4 gap-y-6 mb-10 pb-10 border-b border-slate-100"
          aria-hidden="true"
        >
          {[0, 1, 2, 3, 4, 5].map((i) => (
